<!-- Вид письма. Данный вид будет передаваться в ШАБЛОН mail/layouts/html.php - $content
 В почтовых сервисах есть некоторые проблемы со стилями, по этому их лучше задавать
