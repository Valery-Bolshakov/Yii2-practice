<!--Создали файл который формирует внешний вид(верстка) виджета меню MenuWidget и
задает ссылки на категории продуктов виджета-->
...
<!--    Url::to формирует ссылку типа: http://yii2-practice/web/index.php?r=category%2Fview&id=1 -
        которую мы настроили до вида http://yii2-practice/category/6 в правилах urlManager
