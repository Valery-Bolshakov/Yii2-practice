...
<head>
    <!--так как корневая папка для админского шаблона находится в дирректории web/adminlte то меняем
    базовые ссылки на "/adminlte/". Данный путь будет добавлен к началу всех подключаемых ссылкок,
    скриптам, картинкам и т.д. -->
    <base href="/adminlte/">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <!--Меняем имя пользователя шаблона на то что достали из БД-->
