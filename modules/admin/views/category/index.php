...
//                            'parent_id',  // пока что выводит цифры - к какой категории принадлежит товар
                            [
                                ...
                                Он вернет либо обьект модели либо пустоту. Если вернул обьект модели - то у него
                                будет подставляться тайтл родительской категории, а если вернул пустоту "(0)"
                                то подставится 'Самостоятельная категория'*/
                                'value' => function ($data) {
